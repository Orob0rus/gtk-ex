...
// what is this second paramter???
  ...
  m_ComboBox_Position.signal_changed().connect( sigc::mem_fun(*this, &Window::on_combo_position) );
  m_ComboBox_Position.set_active(0); // 1st value Top, this will be default value 
  // Dropdown menu end
  ...
  m_adjustment_digits->signal_value_changed().connect(sigc::mem_fun(*this,
    &Window::on_adjustment1_value_changed));
  ...
  m_adjustment_pagesize->signal_value_changed().connect(sigc::mem_fun(*this,
    &Window::on_adjustment2_value_changed));
