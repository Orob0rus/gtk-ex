...
protected:
	...
	// Child Widgets
	Gtk::Box m_VBox_Top, m_VBox2, m_VBox_HScale, m_HBox_Scales, m_HBox_Combo, m_HBox_Digits, m_HBox_PageSize;
	Glib::RefPtr<Gtk::Adjustment> m_adjustment, m_adjustment_digits, m_adjustment_pagesize;
	Gtk::Scale m_VScale, m_HScale, m_Scale_Digits, m_Scale_PageSize;
